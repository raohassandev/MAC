...
export type DataType = 
  | 'INT8' | 'UINT8'           // 8-bit integer types (1 byte)
  | 'INT16' | 'UINT16'         // 16-bit integer types (1 register)
  | 'INT32' | 'UINT32'         // 32-bit integer types (2 registers)
  | 'INT64' | 'UINT64'         // 64-bit integer types (4 registers)
  | 'FLOAT32' | 'FLOAT'        // 32-bit float (2 registers)
  | 'DOUBLE' | 'FLOAT64'       // 64-bit double (4 registers)
  | 'STRING' | 'ASCII'         // String types
  | 'BCD'                      // Binary Coded Decimal
  | 'BOOLEAN' | 'BIT';         // Boolean/bit value
