...
const Sidebar = ({ isOpen, toggleSidebar }: SidebarProps) => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`fixed inset-y-0 left-0 z-30 w-64 bg-gray-800 overflow-y-auto transition duration-300 transform md:translate-x-0 md:relative md:flex md:flex-col ${
