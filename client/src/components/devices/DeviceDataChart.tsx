    ...
    const fetchData = async () => {
      ...
      for (let i = 0; i < pointCount; i++) {
        const pointTime = new Date(
          now.getTime() - (pointCount - i) * increment
        );
        mockData.push({
      ...
      return (
        <div className='flex flex-col items-center justify-center h-64 text-gray-500'>
          ...
          <button
            ...
            className='mt-4 px-4 py-2 bg-blue-50 text-blue-500 rounded-md hover:bg-blue-100 flex items-center'
          >
    ...
    <Card.Root>
      ...
      <Card.Content>
        <div className='mb-4 flex flex-wrap gap-2 justify-between'>
          ...
          >
            <Tabs.List className='flex border rounded-md overflow-hidden'>
              <Tooltip.Provider>
                <Tooltip.Root>
                  <Tooltip.Trigger asChild>
                    <Tabs.Trigger
          ...
          <div className='flex flex-wrap gap-2'>
            ...
            >
              <Select.Trigger
                className='inline-flex items-center justify-between rounded px-3 py-1.5 text-sm bg-white border border-gray-300 hover:bg-gray-50 focus:outline-none text-gray-700 shadow-sm'
...
>(({ value, children, className, ...props }, forwardedRef) => {
  return (
    <Select.Item
      value={value}
      className={`flex items-center px-6 py-2 text-sm text-gray-700 hover:bg-gray-100 rounded-md outline-none cursor-pointer select-none data-[highlighted]:bg-gray-100 data-[highlighted]:text-gray-900 ${
        className || ''
      }`}
      {...props}
      ref={forwardedRef}
