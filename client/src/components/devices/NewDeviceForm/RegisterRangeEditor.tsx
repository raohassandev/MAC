...
const RegisterRangeEditor: React.FC<RegisterRangeEditorProps> = ({
  ...
  return (
    <Form onSubmit={handleSubmit}>
      <Form.Group>
        <Form.Label htmlFor="rangeName" required>Range Name</Form.Label>
        <Input
          id="rangeName"
          name="rangeName"
      ...
      <Form.Row>
        <Form.Group>
          <Form.Label htmlFor="startRegister" required>Start Register</Form.Label>
          <Input
            id="startRegister"
            name="startRegister"
            type="number"
        ...
        <Form.Group>
          <Form.Label htmlFor="length" required>Length</Form.Label>
          <Input
            id="length"
            name="length"
            type="number"
      ...
      <Form.Group>
        <Form.Label htmlFor="functionCode" required>Function Code</Form.Label>
        <Select
          id="functionCode"
