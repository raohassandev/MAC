...
const DropdownItem = ({
  ...
  >
    ...
    {selected && <Check size={16} className='text-blue-500 ml-2' />}
  </DropdownMenu.Item>
);
...
const DropdownSeparator = ({ className }: { className?: string }) => (
  <DropdownMenu.Separator className={cn('h-px bg-gray-200 my-1', className)} />
);
    ...
    <DropdownMenu.Root onOpenChange={onOpenChange}>
      ...
      <DropdownMenu.Portal>
        <DropdownMenu.Content
          ...
          className={cn(
            'z-50 bg-white rounded-md p-1 shadow-lg border border-gray-200',
