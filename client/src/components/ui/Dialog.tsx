  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'bg-white p-6 shadow-lg rounded-lg border border-gray-200',
...
const DialogHeader = ({ className, children, ...props }: DialogHeaderProps) => (
  <div
    className={cn(
      'flex flex-col space-y-1.5 text-left mb-4 pb-4 border-b border-gray-200',
      className
    )}
    {...props}
  >
...
const DialogFooter = ({ className, children, ...props }: DialogFooterProps) => (
  <div
    className={cn(
      'flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2 mt-4 pt-4 border-t border-gray-200',
      className
    )}
    {...props}
  >
