...
const SystemMonitor = () => {
  ...
  const generateSampleMetrics = (): MetricsData[] => {
    ...
    const hoursToGenerate =
      timeframe === 'hour' ? 12 : timeframe === 'day' ? 24 : 168; // 1 week = 168 hours
  ...
  const displayMetrics =
    metricsData.length > 0 ? metricsData : generateSampleMetrics();
      ...
      <div className='flex justify-between items-center'>
        ...
        <div className='flex items-center space-x-4'>
          <select
            value={timeframe}
            onChange={(e) =>
              setTimeframe(e.target.value as 'hour' | 'day' | 'week')
            }
          ...
          <button
            ...
            disabled={refreshing}
            className='flex items-center text-sm px-3 py-1 rounded-md border border-gray-300 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2'
          >
            <RefreshCw
              size={16}
